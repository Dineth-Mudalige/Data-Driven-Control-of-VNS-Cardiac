...
Runs a closed-loop simulation of the sparsity promoted controller design (section 2.2.1) with the physiological model. The results from this simulation are shown in Figure 3.
